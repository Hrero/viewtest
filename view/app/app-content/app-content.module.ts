...
import { AddressService } from '../ng-sevice/address.service';
...
@NgModule({
    ...
    providers: [EnumService, AddressService, DepartmentService, PowerService, MenuService, JurisdictionService,BtnService,
